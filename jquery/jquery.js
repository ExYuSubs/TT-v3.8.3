 ...
 (function(E,B){
            ...
            o++){
                ...
                k++){
                    ...
                    if(r.selector===h.selector&&(!A||A.test(h.namespace))){
                        ...
                        if(!e||e!==l)C.push({
                            elem:l,handleObj:h,level:r.level
                        }
                        )
                    }
                }
    ...
    var t=E.document,c=function(){
        ...
        b.extend=b.fn.extend=function(){
            ...
            ,K=1,Q=arguments.length,ga=false;
             if(typeof G==="boolean"){
                ga=G;
                G=arguments[1]||{
                }
            ...
            for(;
            K<Q;
            K++)if((j=arguments[K])!=null)for(s in j){
                v=G[s];
                z=j[s];
        ...
        b.extend({
            ...
            ,merge:function(j, s){
                var v=j.length,z=0;
                if(typeof s.length==="number")for(var H=s.length;
                z<H;
                z++)j[v++]=s[z];
                else for(;
                s[z]!==B;
            ...
            ,access:function(j,s,v,z,H,G){
                ...
                if(v!==B){
                    ...
                    for(Q=0;
                    Q<K;
                    Q++)H(j[Q],s,z?v.call(j[Q],Q,H(j[Q],s)):v,G);
                    return j
                }
                return K?H(j[0],s):B
            }
        ...
        if(!(!f||!f.length||!h)){
            ...
            c(function(){
                ...
                if("zoom"in r.style){
                    ...
                    r.style.display="";
                    r.innerHTML="<div style='width:4px;
                    '></div>";
                    c.support.shrinkWrapBlocks=r.offsetWidth!==2
                }
                r.innerHTML="<table><tr><td style='padding:0;
                display:none'></td><td>t</td></tr></table>";
    ...
    c.extend({
        ...
        ,uuid:0,expando:"jQuery"+c.now(),noData:{
    ...
    c.fn.extend({
        ...
        ,addClass:function(a){
            ...
            if(a&&typeof a==="string")for(var b=(a||"").split(ha),d=0,e=this.length;
            d<e;
            d++){
                var f=this[d];
                if(f.nodeType=== 1)if(f.className){
                    for(var h=" "+f.className+" ",l=f.className,k=0,o=b.length;
                    k<o;
                    k++)if(h.indexOf(" "+b[k]+" ")<0)l+=" "+b[k];
        ...
        ,removeClass:function(a){
            ...
            if(a&&typeof a==="string"||a===B)for(var b=(a||"").split(ha),d=0,e=this.length;
            d<e;
            d++){
                var f=this[d];
                if(f.nodeType===1&&f.className)if(a){
                    for(var h=(" "+f.className+" ").replace(sa," "), l=0,k=b.length;
                    l<k;
                    l++)h=h.replace(" "+b[l]+" "," ");
        ...
        ,toggleClass:function(a,b){
            ...
            return this.each(function(){
                if(d==="string")for(var f,h=0,l=c(this),k=b,o=a.split(ha);
                f=o[h++];
                ){
                    k=e?k:!l.hasClass(f);
        ...
        ,hasClass:function(a){
            ...
            b<d;
            b++)if((" "+this[b].className+" ").replace(sa," ").indexOf(a)>-1)return true;
            return false
        }
        ,val:function(a){
            if(!arguments.length){
        ...
        ,guid:1E8,proxy:c.proxy,special:{
            ...
            ,live:{
                add:function(a){
                    ...
                    ,a,{
                        handler:Ka,guid:a.handler.guid
                    }
                    ))
                }
                ,remove:function(a){
    ...
    E.attachEvent&&!E.addEventListener&&c(E).bind("unload",function(){
     ...
     (function(){
        ...
        var k=function(g,i,n,m){
            ...
            else for(u=o.relative[D[0]]?[i]:k(D.shift(),i);
            D.length;
            ){
                g=D.shift();
            ...
            y||(y=u);
            y||k.error(M||g);
            if(f.call(y)==="[object Array]")if(N)if(i&&i.nodeType===1)for(g=0;
            y[g]!=null;
            g++){
            ...
            y[g]!=null;
            g++)y[g]&&y[g].nodeType===1&&n.push(u[g]);
        ...
        k.filter=function(g,i,n,m){
            for(var p,q,u=g,y=[],F=i,M=i&&i[0]&&k.isXML(i[0]);
            g&&i.length;
            ){
        ...
        var o=k.selectors={
            ...
            ,relative:{
                ...
                ,">":function(g,i){
                    ...
                    if(m&&!/\W/.test(i))for(i=i.toLowerCase();
                    p<q;
                    p++){
                        if(n=g[p]){
                            n=n.parentNode;
                        ...
                        for(;
                        p<q;
                        p++)if(n=g[p])g[p]=m?n.parentNode:n.parentNode===i;
                        m&&k.filter(i,g,true)
                    }
                }
                ,"":function(g,i,n){
            ...
            ,find:{
                ...
                ,NAME:function(g,i){
                    if(typeof i.getElementsByName!=="undefined"){
                        for(var n=[],m=i.getElementsByName(g[1]),p=0,q=m.length;
                        p<q;
                        p++)m[p].getAttribute("name")===g[1]&&n.push(m[p]);
            ...
            ,preFilter:{
                CLASS:function(g,i,n,m,p,q){
                    ...
                    for(var u;
                    (u=i[q])!=null;
                    q++)if(u)if(p^(u.className&&(" "+u.className+" ").replace(/[\t\n]/g," ").indexOf(g)>=0))n||m.push(u);
                    else if(n)i[q]=false;
                    return false
                }
                ,ID:function(g){
                ...
                ,CHILD:function(g,i){
                    ...
                    switch(n){
                        ...
                        if(u&&(u.sizcache!==q||!g.nodeIndex)){
                            ...
                            for(m=u.firstChild;
                            m;
                            m=m.nextSibling)if(m.nodeType===1)m.nodeIndex=++y;
                            u.sizcache=q
                        }
                        m=g.nodeIndex-p;
        ...
        try{
            ...
            C=function(g,i){
                ...
                else if(typeof g.length==="number")for(var p=g.length;
                n<p;
                n++)m.push(g[n]);
                else for(;
                g[n];
        ...
        ;
        var L=function(g,i){
            for(var n,m=[],p="",q=i.nodeType?[i]:i;
    ...
    c.fn.extend({
        find:function(a){
            for(var b=this.pushStack("","find",a),d=0,e=0,f=this.length;
            e<f;
            e++){
                d=b.length;
                c.find(a,this[e],b);
        ...
        ,closest:function(a,b){
            ...
            if(c.isArray(a)){
                ...
                if(h&&a.length){
                    ...
                    for(;
                    h&&h.ownerDocument&&h!==b;
                    ){
                        for(l in k){
                            e=k[l];
                            if(e.jquery?e.index(h)>-1:c(h).is(e))d.push({
                                selector:l,elem:h,level:o
                            }
                            )
                        }
                        h= h.parentNode;
    ...
    c.extend({
        ...
        ,nth:function(a,b,d){
            ...
            for(var e=0;
            a;
            a=a[d])if(a.nodeType===1&&++e===b)break;
            return a
        }
    ...
    var za=/ jQuery\d+="(?:\d+|null)"/g,$=/^\s+/,Aa=/<(?!area|br|col|embed|hr|img|input|link|meta|param)(([\w:]+)[^>]*)\/>/ig,Ba=/<([\w:]+)/,db=/<tbody/i,eb=/<|&#?\w+;
    /,Ca=/<(?:script|object|embed|option|style)/i,Da=/checked\s*(?:[^=]|=\s*.checked.)/i,fb=/\=([^="'>\s]+\/)>/g,P={
        ...
        ,domManip:function(a,b,d){
            ...
            if(this[0]){
                ...
                if(f=h.childNodes.length===1?h=h.firstChild:h.firstChild){
                    ...
                    f<o;
                    f++)d.call(b?c.nodeName(this[f],"table")?this[f].getElementsByTagName("tbody")[0]||this[f].appendChild(this[f].ownerDocument.createElement("tbody")): this[f]:this[f],f>0||e.cacheable||this.length>1?h.cloneNode(true):h)
                }
    ...
    c.extend({
                ...
                if(l){
                    if(typeof l==="string"&&!eb.test(l))l=b.createTextNode(l);
                        ...
                        if(!c.support.tbody){
                            ...
                            for(o=k.length- 1;
                            o>=0;
                            --o)c.nodeName(k[o],"tbody")&&!k[o].childNodes.length&&k[o].parentNode.removeChild(k[o])
                        }
        ...
        ,cleanData:function(a){
            ...
            (k=a[l])!=null;
            l++)if(!(k.nodeName&&c.noData[k.nodeName.toLowerCase()]))if(d=k[c.expando]){
    ...
    c.extend({
        ...
        ,cssNumber:{
            zIndex:true,fontWeight:true,opacity:true, zoom:true,lineHeight:true
        }
        ,cssProps:{
    ...
    var mb=c.now(),nb=/<script\b[^<]*(?:(?!<\/script>)<[^<]*)*<\/script>/gi, ob=/^(?:select|textarea)/i,pb=/^(?:color|date|datetime|email|hidden|month|number|password|range|search|tel|text|time|url|week)$/i,qb=/^(?:GET|HEAD)$/,Ra=/\[\]$/,T=/\=\?(&|$)/,ja=/\?/,rb=/([?&])_=[^&]*/
    ...
    c.extend({
        ...
        ,ajax:function(a){
            ...
            ,c.ajaxSettings,a),d,e,f,h=b.type.toUpperCase(),l=qb.test(h);
            ...
            if(w){
                ...
                try{
                    ...
                    w.setRequestHeader("Accept",b.dataType&&b.accepts[b.dataType]?b.accepts[b.dataType]+", *
                    /*;
                     q=0.01":b.accepts._default)
                }
                catch(I){
                }
    ...
    ,vb=/^(?:toggle|show|hide)$/,wb=/^([+\-]=)?([\d+.\-]+)(.*)$/,ba,pa=[["height","marginTop","marginBottom","paddingTop","paddingBottom"],["width","marginLeft","marginRight","paddingLeft","paddingRight"],["opacity"]];
    c.fn.extend({
        show:function(a,b,d){
        ...
        ,animate:function(a,b,d,e){
            ...
            return this[f.queue===false?"each":"queue"](function(){
                ...
                ,f),l,k=this.nodeType===1,o=k&&c(this).is(":hidden"),x=this;
                for(l in a){
                    var r=c.camelCase(l);
                    if(l!==r){
                        a[r]=a[l];
    ...
    c.each({
        slideDown:S("show",1),slideUp:S("hide",1),slideToggle:S("toggle",1),fadeIn:{
            opacity:"show"
        }
        ,fadeOut:{
            opacity:"hide"
    ...
    c.fn.offset="getBoundingClientRect"in t.documentElement?function(a){
        ...
        f=fa(f);
        return{
            top:d.top+(f.pageYOffset||c.support.boxModel&& h.scrollTop||b.scrollTop)-(h.clientTop||b.clientTop||0),left:d.left+(f.pageXOffset||c.support.boxModel&&h.scrollLeft||b.scrollLeft)-(h.clientLeft||b.clientLeft||0)
        }
    }
    :function(a){
        var b=this[0];
    ...
    c.fn.extend({
        ...
        ,offsetParent:function(){
            return this.map(function(){
                for(var a=this.offsetParent||t.body;
