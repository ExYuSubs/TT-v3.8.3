...
function insert_tag($name, $description, $syntax, $example, $remarks)
{
	...
	print("<p><b>$name</b></p>\n");
	print("<table width='100%' border='1' cellspacing='0' cellpadding='3' class='account'>\n");
	print("<tr valign='top'><td width='25%' class='css'>".T_("DESCRIPTION").":</td><td class='css-right'>$description</td></tr>\n");
	print("<tr valign='top'><td class='css'>".T_("SYNTAX").":</td><td class='css-right'><span class='teletype'>$syntax</span></td></tr>\n");
	print("<tr valign='top'><td class='css'>".T_("EXAMPLE").":</td><td class='css-right'><span class='teletype'>$example</span></td></tr>\n");
	print("<tr valign='top'><td class='css'>".T_("RESULT").":</td><td class='css-right'>$result</td></tr>\n");
	if ($remarks != "")
		print("<tr><td class='css'>".T_("REMARKS").":</td><td class='css-right'>$remarks</td></tr>\n");
	print("</table>\n");
}

$test = $_POST["test"];
?>
    <link href="<?php echo $site_config["SITEURL"]; ?>/themes/ExYu-Subs/css/bootstrap.min.css" rel="stylesheet">
    <link href="<?php echo $site_config["SITEURL"]; ?>/themes/ExYu-Subs/css/ttce.css" rel="stylesheet">
    <link href="<?php echo $site_config["SITEURL"]; ?>/themes/ExYu-Subs/css/icons.css" rel="stylesheet">
    <link href="<?php echo $site_config["SITEURL"]; ?>/themes/ExYu-Subs/css/fontawesome-all.min.css" rel="stylesheet">
<script type="text/javascript" src="backend/java_klappe.js"></script>
<br><br>
<div class='torrent-category-detail clearfix'><p><?php echo T_("TAGS_MSG"); ?></p>
<br>
...
insert_tag(
	...
	"[color=#00ff00]This is green text.[/color]",
...
insert_tag(
   "Youtube link",
   "Yoube link or google vide0.",
   "[youtube=<i>URL</i>]",
   "[youtube=https://www.youtube.com/watch?v=F4Fle1O3eU8]",
   "Just copy/paste url"
);
?>
