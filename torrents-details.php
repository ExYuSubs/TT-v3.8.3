...
if ($row["banned"] == "yes"){
	...
	print ("<table border='0' cellpadding='0' width='100%'><tr><td align='center' valign='middle' width='175'><a href=\"download.php?id=$id&amp;name=" . rawurlencode($row["filename"]) . "\"><img src=\"".$site_config["SITEURL"]."/images/download_torrent.png\" border=\"0\" alt='' /></a></td>");
	print ("<td valign='top'><a href='download.php?id=$id&amp;name=" . rawurlencode($row["filename"]) . "' class='buttonS'>".T_("DOWNLOAD_TORRENT")."</a><br />");
