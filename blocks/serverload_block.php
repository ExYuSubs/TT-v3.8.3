...
if (get_user_class() >= 6)
{
	...
	if (strtoupper(substr(PHP_OS, 0, 3)) == "WIN") {
		...
		//echo("".T_("CURRENT_USERS").": $users[0]<br />");
		
		echo "<div style='font:normal 11px Tahoma'>";
			echo "".T_("CURRENT_LOAD").": <font color=#0080FF>$loadnow</font><br />";
			echo "".T_("LOAD_5_MINS").": <font color=#0080FF>$load5</font><br />";
			echo "".T_("LOAD_15_MINS").": <font color=#0080FF>$load15</font><br />";
			echo "<div style='margin-top:7px; margin-bottom:7px'>";
			echo "".T_("OPERATING_SYSTEM").": <br /><font color=#0080FF>$operatingsystem</font><br />";
			echo "</div>";
			echo "".T_("RAM_USED").": <font color=#0080FF>$memused / $memtotal</font><br />";
			echo "".T_("UPTIME").": <font color=#0080FF>$up</font><br />";
		echo "</div>";
