...
if ($user["privacy"] != "strong" || ($CURUSER["control_panel"] == "yes") || ($CURUSER["id"] == $user["id"])) {
	...
	<tr valign="top">
		...
		<td class="css" align="left"><?php echo T_("AVG_DAILY_DL"); ?>: </td><td class="css-right"><?php echo mksize($user["downloaded"] / (DateDiff($user["added"], time()) / 86400)); ?></td></tr>
		<td class="css" align="left"><?php echo T_("AVG_DAILY_UL"); ?>: </td><td class="css-right"><?php echo mksize($user["uploaded"] / (DateDiff($user["added"], time()) / 86400)); ?></td></tr>
