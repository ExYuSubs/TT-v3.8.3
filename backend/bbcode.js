...
//			direction:			"ltr",
			...
			buttons: 			"bold,italic,underline,strike,sup,sub,|,smilebox,img,video,link,|,bullist,numlist,|,fontcolor,fontsize,fontfamily,|,justifyleft,justifycenter,justifyright,|,quote,code,table,removeFormat",
			allButtons: {
				bold : {
					title: CURLANG.bold,
				...
				img : {
					...
					transform : {
						...
						'<img src="{SRC}" width="{WIDTH}" height="{HEIGHT}" class="poster2"/>':"[img width={WIDTH},height={HEIGHT}]{SRC}[/img]"
					}
				},
				bullist : {
				...
				video: {
					...
					transform: {
						'<iframe src="http://www.youtube.com/embed/{SRC}" width="720" height="480" frameborder="0" class="poster2"></iframe>':'[video]{SRC}[/video]'
					}
				},
	...
	$.wysibb.prototype = {
		...
		buildToolbar: function() {
			...
			//var $bbsw = $('<div class="wysibb-toolbar-container modeSwitch"><div class="wysibb-toolbar-btn" unselectable="on"><span class="btn-inner ve-tlb-bbcode" unselectable="on">exyusubs</span></div></div>').appendTo(this.$toolbar);
			var $bbsw = $(document.createElement('div')).addClass("wysibb-toolbar-container modeSwitch").html('<div class="wysibb-toolbar-btn mswitch" unselectable="on"><span class="btn-inner modesw" unselectable="on">eys</span></div>').appendTo(this.$toolbar);
