...
if(OLud('fgcolor'))var ol_fgcolor="#050505";
if(OLud('bgcolor'))var ol_bgcolor="#333333";
if(OLud('cgcolor'))var ol_cgcolor="#111111";
...
if(OLud('textsize'))var ol_textsize=0;
if(OLud('captionsize'))var ol_captionsize=1;
if(OLud('closesize'))var ol_closesize=1;
if(OLud('fgclass'))var ol_fgclass="";
if(OLud('bgclass'))var ol_bgclass="";
if(OLud('cgclass'))var ol_cgclass="";
if(OLud('textpadding'))var ol_textpadding=0;
if(OLud('textfontclass'))var ol_textfontclass="";
if(OLud('captionpadding'))var ol_captionpadding=0;
...
if(OLud('offdelay'))var ol_offdelay=900;
...
if(OLud('padxl'))var ol_padxl=5;
if(OLud('padxr'))var ol_padxr=5;
if(OLud('padyt'))var ol_padyt=5;
if(OLud('padyb'))var ol_padyb=5;
...
o3_offdelay=900,o3_hpos=RIGHT,o3_offsetx=10,o3_offsety=10,o1_fgcolor="",o3_bgcolor="",
o3_cgcolor="",o3_textcolor="",o3_capcolor="",o3_closecolor="",o3_width=200,o3_wrap=0,
o3_wrapmax=0,o3_height= -1,o3_border=0,o3_base=0,o3_status="",o3_autostatus=0,o3_snapx=0,
...
+' border="0" cellpadding="0" cellspacing="0"'+(o3_cgclass?' class="'
...
// LGF utilities
function OLbgLGF(){
return '<table'+OLwd(1)+o3_height+' border="0" cellpadding="0" cellspacing="0"'
+(o3_bgclass?' class="'+o3_bgclass+'"':o3_bgcolor+o3_bgbackground)+'><tr><td>';
}
function OLfgLGF(t){
return '<table'+OLwd(0)+o3_height+' border="0" cellpadding="0" cellspacing="0"'+(o3_fgclass?' class="'+o3_fgclass+'"':o3_fgcolor+o3_fgbackground)
